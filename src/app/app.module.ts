...
import {AppEnterMainComponent} from "./app.enter.main.component";
import {AppBaseMainComponent} from "./app.base.main.component";
...
@NgModule({
    ...
    declarations: [ AppComponent, AppEnterComponent, AppEnterMainComponent,
                        AppHeaderComponent , AppFooterComponent,
                        AppAuthorizationComponent, AppBaseComponent, AppBaseMainComponent,
